  ...
  return (
    <group ref={groupRef} position={[0, 0, 0]}>
      ...
      <mesh position={[0, 0, 0]}>
        ...
        /* what are these box geometry args? they are defining the width, height, and depth of the box */
      ...
      {[0, 1, 2, 3, 4].map((index) => {
        ...
        const isFaulty = index === 1 || index === 3;
          ...
          <group key={index} position={[0, yOffset, 0]}>
            ...
            {[-0.5, -0.3, -0.1, 0.1, 0.3, 0.5].map((xOffset, i) => (
              <mesh key={i} position={[xOffset, 0, 0.92]}>
                ...
                <meshBasicMaterial
                  color={Math.random() > 0.95 ? '#00e5ff' : '#c800c5ff'}
                />
              </mesh>
            ))}
          </group>
